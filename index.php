		...
		<div id="rev_slider_6_1" class="rev_slider fullwidthabanner tp-overflow-hidden" style="display:none;"
			...
			<ul>
				<li data-index="rs-25" data-transition="slideoverhorizontal" data-slotamount="default"
					...
					data-thumb="assets/images/rev-slider/banner-01/100x50_18fc4-slider-bg-1.jpg" data-delay="5120"
					data-rotate="0" data-saveperformance="off" data-title="Slider" data-param1="" data-param2=""
					data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
					data-param9="" data-param10="" data-description="">

					<img src="assets/images/rev-slider/banner-01/18fc4-slider-bg-1.jpg" alt=""
						data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
						data-bgparallax="off" class="rev-slidebg" data-no-retina>


					<div class="tp-caption   tp-resizeme" id="slide-25-layer-10"
						data-x="['right','right','right','right']" data-hoffset="['-65','-65','-40','23']"
						data-y="['top','top','top','top']" data-voffset="['233','233','261','370']" data-width="none"
						...
						style="z-index: 5;"><img src="assets/images/rev-slider/banner-01/monitor.png" alt=""
							data-ww="['578auto','578auto','501px','439px']" data-hh="['580px','580px','404px','354px']"
							data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-25-layer-14"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 6;"><img src="assets/images/rev-slider/banner-01/cloud.png" alt=""
							data-ww="['128px','128px','138auto','138auto']" data-hh="['116px','116px','171px','171px']"
							data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-25-layer-11"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 7;"><img src="assets/images/rev-slider/banner-01/level_up.png" alt=""
							data-ww="['105px','105px','339auto','339auto']" data-hh="['156px','156px','206px','206px']"
							data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-25-layer-12"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 8;"><img src="assets/images/rev-slider/banner-01/paper.png" alt=""
							data-ww="['186auto','186auto','186auto','186auto']"
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-25-layer-15"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 9;"><img src="assets/images/rev-slider/banner-01/speaker.png" alt=""
							data-ww="['187auto','187auto','244px','244px']" data-hh="['206px','206px','278px','278px']"
							data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme" id="slide-25-layer-16" data-x="['left','left','left','left']"
						...
						<div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="10"
							data-origin="50% 50%"><img src="assets/images/rev-slider/banner-01/search.png" alt=""
								data-ww="" data-hh="" data-no-retina> </div>
					</div>
				...
				<li data-index="rs-26" data-transition="slideup" data-slotamount="default" data-hideafterloop="0"
					...
					data-thumb="assets/images/rev-slider/banner-02/100x50_665d1-slider-bg-2.jpg" data-delay="4060"
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-26-layer-21"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 9;"><img src="assets/images/rev-slider/banner-02/smartphone.png" alt=""
							data-ww="['199auto','199auto','199auto','199auto']"
					...
					<div class="tp-caption   tp-resizeme" id="slide-26-layer-19" data-x="['left','left','left','left']"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 10;"><img src="assets/images/rev-slider/banner-02/laptop.png" alt=""
							data-ww="['443auto','443auto','443auto','404px']"
					...
					<div class="tp-caption   tp-resizeme" id="slide-26-layer-20" data-x="['left','left','left','left']"
						...
						style="z-index: 11;">
						<div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="10"
							data-origin="50% 50%"><img src="assets/images/rev-slider/banner-02/search.png" alt=""
								data-ww="['117auto','117auto','117auto','117auto']"
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-26-layer-22"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 12;"><img src="assets/images/rev-slider/banner-02/pie.png" alt=""
							data-ww="['219auto','219auto','219auto','219auto']"
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-26-layer-23"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 13;"><img src="assets/images/rev-slider/banner-02/dollar.png" alt=""
							data-ww="['118auto','118auto','118auto','118auto']"
				...
				<li data-index="rs-24" data-transition="slideright" data-slotamount="default" data-hideafterloop="0"
					data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default"
					data-thumb="assets/images/rev-slider/banner-03/100x50_aa09a-slider-bg-3.jpg" data-delay="4520"
					data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
					data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
					data-param9="" data-param10="" data-description="">

					<img src="assets/images/rev-slider/banner-03/aa09a-slider-bg-3.jpg" alt=""
						data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
						data-bgparallax="off" class="rev-slidebg" data-no-retina>
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-24-layer-14"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 5;"><img src="assets/images/rev-slider/banner-03/chart.png" alt=""
							data-ww="['138px','138px','138auto','138auto']" data-hh="171px" data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme" id="slide-24-layer-10"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 6;"><img src="assets/images/rev-slider/banner-03/smartphone.png" alt=""
							data-ww="['501px','501px','501px','439px']" data-hh="['404px','404px','404px','354px']"
							data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-24-layer-11"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 7;"><img src="assets/images/rev-slider/banner-03/card.png" alt=""
							data-ww="['339auto','339auto','339auto','339auto']"
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-24-layer-12"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 8;"><img src="assets/images/rev-slider/banner-03/pie.png" alt="" data-ww=""
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-24-layer-15"
						...
						data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
						data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
						style="z-index: 9;"><img src="assets/images/rev-slider/banner-03/screen.png" alt=""
							data-ww="['244px','244px','244px','244px']" data-hh="['278px','278px','278px','278px']"
							data-no-retina> </div>
				...
				<div class="col-lg-8 mx-auto">
					<form action="#" class="xs-inline-form" method="post">
						<div class="row no-gutters">
							<div class="col-lg-6">
								<input type="url" name="website" id="website" placeholder="Web URL"
									class="form-control">
							</div>
							<div class="col-lg-6">
								<input type="email" name="email" id="emails" placeholder="Email Address"
									class="form-control">
							</div>
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 align-self-center">
					<div class="xs-info-wraper wow fadeInUp">
						...
						<p>Our best-in-class WordPress solution, with additional optimization to make running a
							WooCommerce online store easy. Our prices are clear and straight forward so you can</p>
					...
					<ul class="nav nav-tabs main-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="tab-one-area" data-toggle="tab" href="#tab-one" role="tab"
								aria-controls="tab-one" aria-selected="true"><span class="icon-holder"><img
										src="assets/images/service-tab/icon-1.png" alt=""></span> Real Time
								Analytics</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="tab-two-area" data-toggle="tab" href="#tab-two" role="tab"
								aria-controls="tab-two" aria-selected="false"><span class="icon-holder"><img
						...
						<li class="nav-item">
							<a class="nav-link" id="tab-three-area" data-toggle="tab" href="#tab-three" role="tab"
								aria-controls="tab-three" aria-selected="false"><span class="icon-holder"><img
						...
						<li class="nav-item">
							<a class="nav-link" id="tab-four-area" data-toggle="tab" href="#tab-four" role="tab"
								aria-controls="tab-four" aria-selected="false"><span class="icon-holder"><img
						...
						<li class="nav-item">
							<a class="nav-link" id="tab-five-area" data-toggle="tab" href="#tab-five" role="tab"
								aria-controls="tab-five" aria-selected="false"><span class="icon-holder"><img
										src="assets/images/service-tab/icon-5.png" alt=""></span> Social Marketing</a>
						</li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane fadeInRight animated show active" id="tab-one" role="tabpanel"
							aria-labelledby="tab-one-area">
								...
								<div class="row">
									...
									<div class="col-lg-7 col-md-6">
										<div class="service-preview-content">
											...
											<p>We work systematically to integrate corporate responsibility in our core
												business and make our expertise available for the benefit of the
												societies where we operate. </p>
											<p>A successful website obviously needs great design to be one of the top 10
												IT companies in India, but the web design is not enough.</p>
						...
						<div class="tab-pane fadeInRight animated" id="tab-two" role="tabpanel"
							aria-labelledby="tab-two-area">
							<div class="single-service-preview">
								<div class="row">
									<div class="col-lg-5 col-md-6">
										<div class="service-preview-img">
						...
						<div class="tab-pane fadeInRight animated" id="tab-three" role="tabpanel"
							aria-labelledby="tab-three-area">
							<div class="single-service-preview">
								<div class="row">
									<div class="col-lg-5 col-md-6">
										<div class="service-preview-img">
						...
						<div class="tab-pane fadeInRight animated" id="tab-four" role="tabpanel"
							aria-labelledby="tab-four-area">
							<div class="single-service-preview">
								<div class="row">
									<div class="col-lg-5 col-md-6">
										<div class="service-preview-img">
						...
						<div class="tab-pane fadeInRight animated" id="tab-five" role="tabpanel"
							aria-labelledby="tab-five-area">
							<div class="single-service-preview">
								<div class="row">
									<div class="col-lg-5 col-md-6">
										<div class="service-preview-img">
									...
									<div class="xs-single-pricing">
										<div class="pricing-header">
											...
											<div class="pricing-img-block">
												<img src="assets/images/pricing/pricing-1.png"
								...
								<div class="col-lg-4 col-md-6">
									<div class="xs-single-pricing active">
										<div class="pricing-header">
											...
											<div class="pricing-img-block">
												<img src="assets/images/pricing/pricing-2.png"
													alt="hostinza pricing image">
											</div>
								...
								<div class="col-lg-4 col-md-6">
									<div class="xs-single-pricing">
										<div class="pricing-header">
											...
											<div class="pricing-img-block">
												<img src="assets/images/pricing/pricing-3.png"
													alt="hostinza pricing image">
											</div>
											<h2 class="price-table"><sup>$</sup>49.99 <sub>/mo</sub></h2>
										</div>
				...
				<div class="col-lg-10 mx-auto">
					<div class="testimonial-slider-preview owl-carousel" id="sync1">
						<div class="single-testimonial-preview">
							<p>“ We work systematically to integrated corporate responsibility in our corein business
								and make our expertise available for the benefit ”</p>
							<span class="border-line"></span>
						</div>
						<div class="single-testimonial-preview">
							<p>“ We work systematically to integrated corporate responsibility in our corein business
								and make our expertise available for the benefit We work systematically to integrated
								corporate responsibility in our corein business and make our expertise available for the
								benefit ”</p>
							<span class="border-line"></span>
						</div>
						<div class="single-testimonial-preview">
					...
					<div class="single-blog-post-thumb">
						...
						<div class="post-body">
							<div class="entry-header">
								<h4 class="entry-title"><a href="blog-single.html">Twice profit than before you ever got
										in business</a></h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="newsletter-thumb-wraper">
						...
						<div class="newsletter-thumb-content">
							...
							<p>Enter your email in the box below to receive latest news and information about our
								activities</p>
